...
\begin{lemma} % Lemma 6
  ...
  Then $c$ is differentiable in every point $x_0 \in D$ and it holds that $D C(x_0) = 0 \in \mathbb R^{n\times m}$.
...
\begin{proof}
  Let $x_0 \in D$ and $\overline{K_r(x_0)} \subseteq D$. Let $h, k \in \mathbb R$ and $\card{h}, \card{k} \leq \frac r2$.
  ...
  \[ \varphi'(\lambda) \cdot h = h \cdot [Df(x_0 + \lambda e_i + ke_j) - Df(x_0 + \lambda e_i)] e_i \]
...
\begin{enumerate}
  \item Let $f: X \to Y$ be continuous. Let $X$ be compact. Prove that $f(X)$ is compact.
  \item Give and prove H\"older's inequality.
  \item Prove: If $f$ is analytical in $x_0$, then $f = T_f(x, x_0)$.
  ...
  \item Let $\gamma: I \to \mathbb R^3$ be regular, smooth and $\norm{\gamma'(t)} = 1$. Define its curvature, circle of curvature, osculating plane and main normal vector. Show $\angel{T, N} = 0$. Give the approximating behavior of curvature and the circle of curvature.
\end{enumerate}
