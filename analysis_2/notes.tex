...
\begin{theorem} % Satz 1
  Let $\gamma: [a,b] \to \mathbb R^n$ be a continuous curvature parameterization.
...
\begin{remark}
  ...
  Let $\gamma: I \to \mathbb R^n$ be a regular $\mathcal C^1$-curvature parameterization.
...
\begin{definition}
  We call $s = l(t) = \int_{t_0}^t \norm{\gamma'(\tau)}_2 \, d\tau$ the arc length parameter of the curvature parameterization $\gamma$.
\end{definition}
...
\begin{remark}
  ...
  But it provides the property, that the curvature is traversed with uniform speed.
\end{remark}

\index{Parameterization by a curvature's arc length}
\begin{definition} % Definition 5
  Let $\gamma: I \to \mathbb R^n$ be a regular curvature.
...
\begin{remark}
  ...
  Hence, curvature parameter and arc length parameter differ only by constant $t_0$. For $t_0 = 0$, $s = t$.
\end{remark}

Let $\gamma$ be regular and a $\mathcal C^2$ curvature and $\norm{\gamma'(t)}_2 = 1 \forall t \in I$, hence $\gamma$ is parameterized by the arc length.
