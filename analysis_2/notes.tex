...
\begin{proof}
  ...
  \begin{align*}
    d(x_n, x_{n+k}) &\leq d(x_n, x_{n+1}) + d(x_{n+1}, x_{n+2}) + \dots + d(x_{n+k-1}, x_{n+k}) \qquad \text{by triangle inequality} \\
      &= d(x_n, x_{n+1}) + d(f(x_n), f(x_{n+1})) + d(f(x_{n+1}), f(x_{n + 2})) + \dots + d(f(x_{n+k-2}), f(x_{n+k-1})) \\
