...
\[ = \lim_{n\to\infty} \left(\left.\frac{x^{n+1}}{n+1} |_0^1\right)^{\frac12} \]
\[ \limt_{n\to\infty} \left(\frac{1^{n+1}}{n + 1} - \frac{0^{n+1}}{n+1}\right)^{\frac12} = \lim \left(\frac{1}{n+1}\right)^{\frac12} = 0 \]
