...
\begin{proof}[Proof of Theorem~\ref{theorem:7.2}]
	...
	Requirements of Global Newton's method (incl. step size choice):
...
This define the Quasi-Newton condition (sometimes called \emph{secant method}\index{Secant method}).
