...
\begin{theorem}
	\label{theorem:5.1}
	There exists a (finite) solution for the barriere problem if and only if the admissible set for the primal as well as the dual problem has a non-empty interior.
\end{theorem}
...
\begin{proof}
	Follows from the previous theorem and Lemma~\ref{lemma:5.3}, which will be proven in the practicals.
\end{proof}
